...
\paragraph{}
The Ticker class is located high up in the package hierarchy because of how important and central its role is. It was one of the tricker parts of the project implementation because we had to decide how to implement the publish-subscribe relationship and how to have the ticker ticking at a constant rate. The ticker had to be once re-worked because of some complexity that arose. However, the one aspect that remained constant was the importance of having the publish-subscribe relationship. 
